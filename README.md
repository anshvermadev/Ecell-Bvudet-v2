...
**The official web platform for the Entrepreneurship Cell of Bharati Vidyapeeth University (E-Cell BVUDET).**

A premium, highly interactive single-page application built to inspire and connect student entrepreneurs, startup founders, and industry mentors.

</div>

## ✨ Features

- **Immersive User Experience:** High-performance parallax effects and dynamic smooth scrolling powered by Locomotive Scroll.
- **Cinematic Typography:** Custom letter-by-letter text reveal animations and split-text styling via Splitting.js and GSAP.
